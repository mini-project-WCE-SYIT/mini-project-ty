            ...
            <FlexCol gap="1.5rem">
              ...
              <Box className="select-input">
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value="Option 1">Special Awards and Recognitions</MenuItem>
                    <MenuItem value="Option 2">Personal Development and Skills</MenuItem>
                    <MenuItem value="Option 3">Innovation and Invention</MenuItem>
                    <MenuItem value="Option 3">Environmental and Sustainability Achievements</MenuItem>
                    <MenuItem value="Option 3">Cultural and Diversity Contributions</MenuItem>
                    <MenuItem value="Option 3">Health and Wellness</MenuItem>
                  </Select>
                </FormControl>
              </Box>
              <TextField
