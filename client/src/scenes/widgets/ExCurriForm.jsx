            ...
            <FlexCol gap='1.5rem'>
              ...
              <Box className='select-input'>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value='Sports Achievements'>
                      Sports Achievements
                    </MenuItem>
                    <MenuItem value='Arts and Creative Achievements'>
                      Arts and Creative Achievements
                    </MenuItem>
                    <MenuItem value='Leadership and Service'>
                      Leadership and Service
                    </MenuItem>
                    <MenuItem value='Competitions and Contests'>
